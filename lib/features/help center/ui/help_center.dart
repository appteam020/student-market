...
import 'package:market_student/features/help%20center/controller/help_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ChangeNotifierProvider(
        create: (context) =>HelpCenterController(),
        child: Consumer<HelpCenterController>(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8.h,),
                      ...
                      validator:(val){
                        if(val!.isEmpty){
                          return "يرجي كتابة سؤالك او استفسارك ";
                        }return null;
                      }
                    ),
                    SizedBox(height: 16.h,),
                    value.requestState==RequestState.loading?
                    Center(
                      child: CircularProgressIndicator(),
                    ):
                    CustomButton(
                      text: tr("Send_question"), 
                      onPressed:(){
                        value.addQuestion(context);
